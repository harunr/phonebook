...
$show_user = "SELECT * FROM contact WHERE id = $id";
...
<body>
	...
	<div class="container user-image">
		...
		<div class="row">
            ...
            <img class="img-user-details" src="https://staging.webtricker.com/phonebook/img/uploaded/<?php echo $result['imagename']; ?>">
...
<?php } ?>
		...
		<div class="row">
			...
			<form action="" method="post" class="col-md-12" enctype="multipart/form-data">
				...
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="name" placeholder="Md Tofael Ahmed" value="<?php echo $result['name']; ?>">
				...
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="phone" placeholder="01724376407" value="<?php echo $result['phone']; ?>">
				...
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="address" placeholder="Jamalpur , Bangladesh" value="<?php echo $result['address']; ?>">
    ...
    if (isset($_POST['update'])) {
        ...
        $update_contact_query = "UPDATE contact SET name = '$name', phone = '$phone' , email = '$email',address = '$address' WHERE id = $id";
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $update_contact_query = "UPDATE contact SET name = '$name', phone = '$phone' , email = '$email', address = '$address' , imagename = '$file_name_new' WHERE id = $id";
